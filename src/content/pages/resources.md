...
intro:
  en: "Get started: Access JC GoAI’s learning and teaching resources, online courses, and pre-learning modules here."
...
items:
  ...
  - title: { en: "AI Usage Guideline", zh: "人工智能使用指引" }
    body:
      en: "Review the project’s AI usage guideline for responsible and appropriate use of AI tools in teaching and learning."
      zh: "請參閱計劃的人工智能使用指引，了解在學與教中負責任及適切地使用人工智能工具的要求。"
    href: "https://drive.google.com/drive/folders/1OUbT6J9X1XzwgYo6kNeAHgmnjQfNlFKe?usp=sharing"
    linkLabel: { en: "Open AI Usage Guideline", zh: "開啟人工智能使用指引" }
  ...
  - title: { en: "Learning and Teaching Resources", zh: "學與教資源" }
    ...
    links:
      ...
      - href: "https://forms.gle/pCVSXUm1CPbek1ev8"
        ...
        note:
          en: "If you do not have access to the Project's shared folder, please fill in this form."
          zh: "如你未能存取計劃的共用資料夾，請填寫此表格。"
    warning:
  ...
  - title: { en: "Teacher Self-paced Online Courses (Certificates upon completion!)", zh: "教師自學網上課程" }
    body:
      en: "The two self-paced online courses, Generative AI for Educators & AI Literacy for Educators, are now available! All teachers are highly recommended to complete these courses prior to the workshop. How to access: Create an account with your email; after logging in, enter the global password “goai” and complete the survey. Remember to complete the self-paced online AI courses before the workshop."
      zh: "兩門自學網上課程「Generative AI for Educators」及「AI Literacy for Educators」現已開放！強烈建議所有教師於工作坊前完成。登入方法：以電郵開設帳戶，登入後輸入通用密碼「goai」並完成問卷。請記得在工作坊前完成自學網上人工智能課程。"
